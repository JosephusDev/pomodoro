...
export default function Resume({ criadas = 0, concluidas = 0 }: ResumeProps) {
	return (
		<View>
			<View style={s.container}>
				...
				<View style={s.group}>
					...
					<Text style={[s.badge, { backgroundColor: colors.green.base }]}>{concluidas}</Text>
				</View>
			</View>
			<View style={s.view_progress}>
				...
				/>
				<Text style={s.progress_text}>{criadas > 0 ? Math.round((concluidas / criadas) * 100) : 0}% concluídas</Text>
			</View>
		</View>
	)
}
