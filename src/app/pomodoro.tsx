    ...
    <ScrollView>
      <View style={s.main}>
        ...
        <View style={s.container}>
          ...
          >
            <Text style={s.descriptionIA}>{pomodoroPlan ? pomodoroPlan : 'Informe o que vai estudar se deseja receber sugestões de estudo e gestão de tempo através de Inteligência Artificial'}</Text>
            <Button
              title='Fechar'
